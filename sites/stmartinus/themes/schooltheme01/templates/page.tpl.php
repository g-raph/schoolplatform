...
<div id="header-top" class="outerbox">
  <div id="header-top-inner" class="inner clearfix">
    ...
    <?php if (!$logo): ?>
      <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" id="logo">
        <img src="/sites/all/assets/schooltheme01/logo.svg" alt="<?php print t('Home'); ?>" />
      </a>
    <?php endif; ?>
...
<div id="footer-bottom" class="outerbox">
  <div id="footer-bottom-inner" class="inner clearfix">
    ...
    <div class="copyright">©2014 - Lagere school Sint-Martinus - Herk-de-Stad </div>
    <div class="g-raph"><a href="http://g-raph.be" target="_blank"><div class="popup">This website is created by G-raph!</div><img src="/sites/all/themes/stmartinus/images/logo-g-raph.png"></a></div>
  </div>
</div>