...
To use these stylesheets, rename the files and pocomega with the name of your theme.
...
pocomega-alpha-default-narrow.css  
...
pocomega-alpha-default-normal.css
...
pocomega-alpha-default-wide.css
